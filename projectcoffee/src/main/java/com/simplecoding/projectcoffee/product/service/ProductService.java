...
import com.simplecoding.projectcoffee.product.mapper.ProductMapper;
...
public class ProductService {
    ...
    // 1️⃣ 상품 전체 조회
    public List<?> selectProductList(Criteria criteria) {
        return productMapper.selectProductList(criteria);
    }
//총개수 구하기
    public int selectProductListTotCnt(Criteria criteria){
        return productMapper.selectProductListTotCnt(criteria);
    }
